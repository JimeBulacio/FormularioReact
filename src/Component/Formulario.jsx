...
const Formulario = ({ setPersona, persona, personas, setPersonas }) => {
    ...
    function handleChange(event) {
        ...
        //con los 3 puntos se dice operador de propagacion, y lo que le decimos es que nos traiga todo lo que esta en el state (la informacion que tiene el "almacen"), o sea todas las propiedeades
        setPersona({
            ...persona,
